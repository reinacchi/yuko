...
class Client extends EventEmitter {
    ...
    createMessage(channelID, content) {
        ...
        return this.rest.request("POST", Endpoints.CHANNEL_MESSAGES(channelID), content).then((msg) => new Message(this, msg));
    }
    ...
    editMessage(channelID, messageID, content) {
        ...
        return this.rest.request("PATCH", Endpoints.CHANNEL_MESSAGE(channelID, messageID), content).then((msg) => new Message(this, msg));
    }
