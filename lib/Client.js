...
class Client extends EventEmitter {
    ...
    banGuildMember(guildID, memberID, options) {
        return this.rest.request("PUT", Endpoints.GUILD_BAN(guildID, memberID), {
            delete_message_days: options.deleteMessageDays ? options.deleteMessageDays : 0,
     ...
     * @param {String} reason The reason which will de displayed in the audit log
     * @returns {Promise<void>}
     */
    deleteInvite(inviteID, reason) {
        return this.rest.request("DELETE", Endpoints.INVITE(inviteID), {
            reason
        });
    }
     ...
     * @returns {Promise<void>}
     */
    removeGuildMember(guildID, memberID, reason) {
    ...
    removeGuildMemberRole(guildID, memberID, roleID, reason) {
        return this.rest.request("DELETE", Endpoints.GUILD_MEMBER_ROLE(guildID, memberID, roleID), reason);
    }
