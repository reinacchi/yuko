...
class Message extends Base {
    ...
    _load(data) {
        ...
        if (data.message_reference) {
            this.messageReference.channelID = data.message_reference.channel_id;
            this.messageReference.guildID = data.message_reference.guild_id;
            this.messageReference.messageID = data.message_reference.message_id;
