...
module.exports.CHANNEL_CROSSPOST = (channelID, messageID) => `/channels/${channelID}/messages/${messageID}/crosspost`;
...
module.exports.CHANNEL_MESSAGE_REACTION = (channelID, messageID, reaction) => `/channels/${channelID}/messages/${messageID}/reactions/${reaction}`;
module.exports.CHANNEL_MESSAGE_REACTION_USER = (channelID, messageID, reaction, userID) => `/channels/${channelID}/messages/${messageID}/reactions/${reaction}/${userID}`;
module.exports.CHANNEL_MESSAGE_REACTIONS = (channelID, messageID) => `/channels/${channelID}/messages/${messageID}/reactions`;
...
module.exports.WEBHOOK_MESSAGE = (hookID, token, messageID) => `/webhooks/${hookID}/${token}/messages/${messageID}`;
...
module.exports.ROLE_ICON = (roleID, icon) => `/role-icons/${roleID}/${icon}`;
