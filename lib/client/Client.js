...
class Client extends EventEmitter {
     ...
     * @param {Boolean} [options.allowedMentions.roles] Whether to allow mention roles or not
     * @param {Boolean} [options.allowedMentions.users] Whether to allow mentions users or not
     * @param {Array<String>} [options.intents] The intents applied
     * @param {Boolean} [options.shard=true] Whether to enable sharding or not
